...
function Note(){
    ...
    //updated get note fetch, need to update the rest 
    ...
    const saveNote_database = async (note) =>{
        try{
            ...
            //two cases: 1: temp note(hasn't save to the database). 2: saved noted-->update it
            if (note.id){
                //case 2
                //update existed note with new content
                ...
                //get actual note id and content
    ...
    const onAddNote = async () => {
        //create a temporary note based on the created date
        const newNote = {
            tempId: Date.now(),
            title: "Untitled Note",
            body: "",
